...
\usepackage{fontspec, enumitem, xcolor, hyperref, parskip, datetime2, titlesec, setspace, tabularx}
...
\textmb{Languages:} ${ for(programmingLanguages) } ${ it }${ sep }, ${ endfor }.

\textmb{Spoken languages:} ${ for(languages) } \lowercase{${it.fluency }} in ${ it.language }${ sep }, ${ endfor }.
